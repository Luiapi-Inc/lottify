...
5. Accounting uses posting instant/accounting period, Product operations use Product timezone, aggregate reports declare timezone, ranges are half-open `[from,to)`, and closed-period corrections are current-period adjustments linked to original facts.
